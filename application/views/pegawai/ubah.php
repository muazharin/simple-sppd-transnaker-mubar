                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="name" class="form-control form-control"
                                    value="<?= $detail->nama_pegawai;?>" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select name="pangkat" class="form-control">
                                    ...
                                    <?php foreach ($pangkat as $s) : 
										if ($s->id_pangkat == $detail->pangkat) {
									?>
                                    <option value="<?= $s->id_pangkat; ?>" selected>
                            ...
                            <div class="col-sm-10">
                                <select name="jabatan" class="form-control">
                                    <?php foreach ($jabatan as $s) : 
										if ($s->id_jabatan == $detail->jabatan) {
									?>
                                    <option value="<?= $s->id_jabatan; ?>" selected><?= $s->nama_jabatan; ?></option>
                                    <?php } else { ?>
